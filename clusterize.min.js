...
tag:null,content_tag:null,show_no_data_row:!0,no_data_class:"clusterize-no-data",no_data_text:"No data",keep_parity:!0,verify_change:!1};a.options={};"rows_in_block blocks_in_cluster verify_change show_no_data_row no_data_class no_data_text keep_parity tag".split(" ").forEach(function(h){a.options[h]="undefined"!=typeof b[h]&&null!=b[h]?b[h]:c[h]});["scroll","content"].forEach(function(c){a[c+"_elem"]=b[c+"Id"]?document.getElementById(b[c+"Id"]):b[c+"Elem"];if(!a[c+"_elem"])throw Error("Error! Could not find "+
c+" element");});var d=b.rows||[],f={data:""},g=a.scroll_elem.scrollTop;a.exploreEnvironment(d);a.insertToDOM(d,f);a.scroll_elem.scrollTop=g;var l=!1,k=function(){l!=(l=a.getClusterNum())&&a.insertToDOM(d,f)};a.scroll_elem.addEventListener("scroll",k);a.destroy=function(b){a.scroll_elem.removeEventListener("scroll",k);a.html(b?a.generateEmptyRow().join(""):d.join(""))};a.update=function(b){d=a.isArray(b)?b:[];b=a.scroll_elem.scrollTop;a.insertToDOM(d,f);a.scroll_elem.scrollTop=b};a.append=function(b){b=
a.isArray(b)?b:[];b.length&&(d=d.concat(b),a.insertToDOM(d,f))};a.clear=function(){a.update([])};a.getRowsAmount=function(){return d.length}};e.prototype={constructor:e,exploreEnvironment:function(b){var a=this.options;a.content_tag=this.content_elem.tagName.toLowerCase();if(!a.item_height||!a.tag){if(!b.length)return;g&&9>=g&&(a.tag=b[0].split("<")[1].split(" ")[0].split(">")[0]);this.html(b[0]+b[0]+b[0]);b=this.content_elem.children[1];a.tag||(a.tag=b.tagName.toLowerCase());a.item_height=b.offsetHeight}a.block_height=
a.item_height*a.rows_in_block;a.rows_in_cluster=a.blocks_in_cluster*a.rows_in_block;a.cluster_height=a.blocks_in_cluster*a.block_height},getClusterNum:function(){var b=this.options;return Math.floor(this.scroll_elem.scrollTop/(b.cluster_height-b.block_height))},generateEmptyRow:function(){var b=this.options;if(!b.tag||!b.show_no_data_row)return[];var a=document.createElement(b.tag),c=document.createTextNode(b.no_data_text),d;a.className=b.no_data_class;"tr"==b.tag&&(d=document.createElement("td"),
