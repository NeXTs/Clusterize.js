...
(q=a.getClusterNum())&&a.insertToDOM(e,h)},r=0,t=function(){clearTimeout(r);r=setTimeout(a.refresh,100)};n("scroll",a.scroll_elem,g);n("resize",window,t);a.destroy=function(b){l("scroll",a.scroll_elem,g);l("resize",window,t);a.html((b?a.generateEmptyRow():e).join(""))};a.refresh=function(){a.getRowsHeight(e)&&a.update(e)};a.update=function(b){e=p(b)?b:[];b=a.scroll_elem.scrollTop;a.insertToDOM(e,h);a.scroll_elem.scrollTop=b};a.clear=function(){a.update([])};a.getRowsAmount=function(){return e.length};
